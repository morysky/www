...
<div id='container'>
    <div id='contentre' class='content'>
        ...
        ?>
        <h2 class="recommend-hd">推荐你最喜欢的博客给大家！</h2>

        <div class="recommend-bd">
            <div class="recommend-top"></div>
            <div class="recommend-content">
                <form method="post" action="index.php?m=post.recomadd" id="J_RecommendForm">
                    <p class="recommend-dlog-url-holder">
                        <label for="recommend-dlog-url">输入要推荐博客的uid<span> (如http://localhost/paipang/index.php?m=ta&uid=4 则uid为4）</span></label>
                    </p>

                    <p><input type="text" value="<?php echo $tta;?>" id="recommend-dlog-url" name="tuid"></p>
