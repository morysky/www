...
<div class="post">
    <div class="posttop">
        ...
        <?php echo "<b  style='font-size:26px' ><a style='color:#000000' href="; ?><?php if (PPREWRITE == 1) {
...
<?php }
    ...
    <div class="itemfooter">
        <div class="date">
            ...
            <a href="index.php?m=show&id=<?php echo $value['did']; ?>">
                <?php echo APP::F('format_time', $value['thedate']);?>
            </a>
...
<?php
    ...
    $pages->setShowPageNum(6);     // 设置显示的页数
