...
<ol id="posts">
    <li class="topitem">
        <img style="width:expression(this.width > 160 ? '160px' : this.width);max-width:160px;"
             ...
             }?>'></img> <b style='font-size:38px'><?php echo $thinfo[0]['name'];?></b>

        <p>
            <b style='font-size:28px'><?php if ($thinfo[0]['descs']) {
                echo  $thinfo[0]['descs'];
            }?></b>
    </li>
    <?php
...
<?php
    ...
    <?php echo "<b><a href="; ?><?php if (PPREWRITE == 1) {
        ...
        echo "index.php?m=show&id=" . $value['did'] . " >" . $value['title'];
    } ?><?php echo "</a></b><p>";
}?>
...
<?php $theurl = "index.php?m=ta&uid=" . $uid . $linktype; ?>
