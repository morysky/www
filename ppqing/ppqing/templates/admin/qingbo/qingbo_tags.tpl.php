...
<head>
    ...
    <title>标签列表 - 标签管理 - 运营管理--power by 身旁网&拍旁轻博客</title>
...
<body>
<div class="main-wrap">
    <div class="path"><span class="path-icon"></span>当前位置：运营管理<span> &gt; </span>标签管理<span> &gt; </span>标签列表</div>
    <div class="set-wrap">
        <h4 class="main-title">标签列表</h4>

        <div class="set-area-int">
            <div class="user-list-box1">
                <p class="serch-tips">请输入标题搜索标签，然后选择相应的添加操作</p>

                <div class="serch-user">
                    <form action="<?php echo URL('admin/qingbo.etags');?>" id="searchUser" method="post">
                        <span><strong>搜索包含以下标签内容：</strong></span>
            ...
            <div class="user-list">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-border">
                    ...
                    <?php if ($list): ?>
                        ...
                        <tr>
                            <td><?php echo $value['tarid'];?></td>
                            <td><?php echo $value['tarname'];?></td>
                            <td><?php echo $value['num'];?></td>
                            <td>
                                <a href="<?php  echo URL('index.tags', 'id=' . $value['tarid'], 'index.php');?>"
                                   class="view-weibo" target="_blank">查看内容</a>
                                <a href="<?php echo URL('admin/qingbo.deltag', 'id=' . $value['tarid'] . '&ban=1');?>"
                                   class="del-icon">删除</a>
                            </td>
                        </tr>
                            <?php endforeach; ?>
