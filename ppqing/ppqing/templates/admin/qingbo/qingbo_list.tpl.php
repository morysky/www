...
<head>
    ...
    <title>内容列表 - 内容管理 - 运营管理--power by 身旁网&拍旁轻博客</title>
...
<body>
<div class="main-wrap">
    <div class="path"><span class="path-icon"></span>当前位置：运营管理<span> &gt; </span>内容管理<span> &gt; </span>内容列表</div>
    <div class="set-wrap">
        <h4 class="main-title">内容列表</h4>

        <div class="set-area-int">
            <div class="user-list-box1">
                <p class="serch-tips">请输入标题搜索内容，然后选择相应的添加操作</p>

                <div class="serch-user">
                    <form action="<?php echo URL('admin/qingbo.econtent');?>" id="searchUser" method="post">
                        <span><strong>搜索包含以下标题内容：</strong></span>
