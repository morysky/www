...
<html>
    <head>
        ...
        <link href="/ot/Public/Install/css/install.css" rel="stylesheet">
        ...
        <script src="/ot/Public/static/bootstrap/js/bootstrap.js"></script>
    </head>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/ot/install.php?s=/Install/step2.html" method="post" target="_self">
